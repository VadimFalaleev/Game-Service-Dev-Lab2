...
- Если открыть сразу, то будет пусто. Спустя некоторое время после перезагрузки страницы там появится статистика вознаграждения за просмотренную рекламу. Соответсвенно, SDK подключен, работает в режиме онлайн и отвечает на запросы.

![image](https://user-images.githubusercontent.com/54228342/194368101-8c3ea41a-3d7c-4038-be0b-a6baddbe439e.png)

- P.S.: Есть возможность установить в проект другие SDK, с поомщью которых можно быстрее и компактнее интегрировать рекламу(Например, с помощью Agawa можно интегрировать рекламу всего одной строчкой, не залезая в html файл), но пока что решил использовать классические возможности Яндекса.
...
- Готовый реферат приложен к рипозиторию в файле "Сравнительная характеристика игровых сервисов.docx".
